    ...
    <section id="knowledges" class="knowledges section mt-4 mb-4">
      <div class="container">
        <div class="row">
        <h2 class="text-center mb-4">Peraturan dan Perundang-Undangan</h2>
              ...
              <div class="knowledge-content">
                ...
                <div class="trainer d-flex justify-content-between align-items-center">
                    <div class="trainer-profile d-flex align-items-center">
                        <i class="bi bi-calendar2-event me-1"></i> {{ $document->created_at->format('d M Y') }}
                    </div>
                    <div class="trainer-rank d-flex align-items-center">
                        <i class="bi bi-eye eye-icon"></i>&nbsp;{{ $document->views }}
                        &nbsp;&nbsp;
        ...
        @endforeach
          ...
          <div class="mt-4 text-center"><a href="/document" class="read-more"><span>Lihat Selengkapnya</span><i class="bi bi-arrow-right"></i></a></div>
        </div>
